...
خدای جنگ رگناروک در پلی‌استیشن ۵ بر اساس بازبینی جمعی وبگاه متاکریتیک امتیاز ۹۴/۱۰۰ را کسب کرده‌است که نشان‌دهندهٔ «تحسین همگانی» است. امتیاز این بازی با قسمت ۲۰۰۵ و ۲۰۱۸ در متاکریتیک برابری کرد.          </p>
