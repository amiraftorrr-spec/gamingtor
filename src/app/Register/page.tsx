      ...
      <div className="w-[460px] bg-black/10 rounded-2xl p-10 text-white backdrop-blur">
        ...
        <Formik
          ...
          onSubmit={(values) => {
            ...
            try {
              sessionStorage.setItem("verify_phone", values.phone);
            } catch {
              // ignore
            }
            router.push(`/Code?phone=${encodeURIComponent(values.phone)}`);
          }}
        >
          {({ values, handleChange }) => {
            const isValid =
            ...
            return (
              <Form className="space-y-6">
                ...
                <div className="relative">
                  <div className="flex bg-white rounded-md overflow-hidden text-black">
                    <div className="px-2 flex items-center">
                      <img src="/iran.webp" alt="Iran flag" className="w-8" />
                    </div>
                ...
                <button
                  type="button"
                  className="w-full border border-white rounded-md py-3 flex items-center justify-center gap-2 cursor-pointer hover:bg-white/10 transition-colors"
                >
                  <img src="/google.webp" alt="Google" className="w-5" />
