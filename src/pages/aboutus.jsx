...
export default function AboutUs() {
  ...
  useEffect(() => {
    // وقتی صفحه لود شد، اسکرول smooth به بالای section
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="bg-[#040410] text-white px-[10%] py-20 font-[shab]"
    >
      <div
      ...
      >
        ...
        <div className="flex justify-center mt-20">
          <button
            onClick={() => navigate("/")}
            className="bg-[#ff4655] hover:bg-[#f9ce34] text-black font-bold px-6 py-3 rounded-full transition-all duration-300 shadow-lg"
          >
            بازگشت به صفحه اصلی
          </button>
        </div>
