    ...
    <div className="min-h-screen bg-[#040410] text-white p-8 rtl">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 space-y-6 text-right rtl">
          ...
          <hr className="border-yellow-400" />
          <p className="text-[#c27575]">
            خدای جنگ رگناروک در پلی‌استیشن ۵ بر اساس بازبینی جمعی وبگاه
            متاکریتیک امتیاز ۹۴/۱۰۰ را کسب کرده‌است که نشان‌دهندهٔ «تحسین
            همگانی» است. امتیاز این بازی با قسمت ۲۰۰۵ و ۲۰۱۸ در متاکریتیک برابری
            کرد.{" "}
          </p>
